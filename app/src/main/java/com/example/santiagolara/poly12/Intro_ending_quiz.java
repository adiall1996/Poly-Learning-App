...
import com.example.santiagolara.poly12.Model.Question;
...
public class Intro_ending_quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_ending_quiz);
    ...
    public void updateQuestion()
    {
        ...
        if(computerCount>5)
        {
            ...
            Intent myIntent = new Intent(Intro_ending_quiz.this,Intro_ending_results.class);
        ...
        {
            databaseReference = FirebaseDatabase.getInstance().getReference().child("Intro").child(String.valueOf(computerCount));
            total++;
